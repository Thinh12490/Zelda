...
function EntityWalkState:update(dt)
    ...
    if self.entity.direction == 'left' then
        ...
        local checkBumped = self:checkBumped()

        if checkBumped.isBumped then
            self.entity.x = checkBumped.objectX + 16 + 0.3
            self.bumped = true
        end  
    elseif self.entity.direction == 'right' then
        ...
        if checkBumped.isBumped then
            self.entity.x = checkBumped.objectX - 0.3 - self.entity.width
            self.bumped = true
        end
    elseif self.entity.direction == 'up' then
        ...
        if checkBumped.isBumped then
            self.entity.y = checkBumped.objectY + 16 + 0.3 - self.entity.height / 2
            self.bumped = true
        end
    elseif self.entity.direction == 'down' then
        ...
        if checkBumped.isBumped then
            self.entity.y = checkBumped.objectY - 0.3 - self.entity.height
            self.bumped = true
        end
    end
end
...
function EntityWalkState:checkBumped()
